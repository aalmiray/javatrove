...
import org.kordamp.javatrove.example02.AppModule;
...
public class GithubImplTest {
    ...
    public void happyPath() throws Exception {
        ...
        // when:
        Promise<Collection<Repository>, Throwable, Repository> promise = github.repositories(ORGANIZATION, 8);
        await().timeout(2, SECONDS).until(promise::state, equalTo(Promise.State.RESOLVED));

        // then:
        promise.done(result -> assertThat(result, equalTo(repositories.subList(0, 8))));
    ...
    public void failurePath() {
        ...
        // when:
        Promise<Collection<Repository>, Throwable, Repository> promise = github.repositories(ORGANIZATION, 5);
