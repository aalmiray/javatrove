 ...
 */
package org.kordamp.javatrove.chat03.client.model;
...
import static org.kordamp.javatrove.chat03.ChatUtil.SERVER_PORT;
...
public class AppModel {
    ...
    public void cleanup(boolean clearMessages) {
        setClient(null);
        setConnected(false);
        if (clearMessages) {
            getMessages().clear();
